...
if (urlParams.has("api")) {
  localStorage.setItem("API_BASE", urlParams.get("api"));
  localStorage.setItem("autocare_api_base", urlParams.get("api"));
}
const BACKEND_RENDER_URL = window.RENDER_BACKEND_URL || "https://autocare-backend-qdkf.onrender.com";
const overrideApiBase = localStorage.getItem("API_BASE") || localStorage.getItem("autocare_api_base");
const API_BASE = window.API_BASE || overrideApiBase || (
